...
import org.firstinspires.ftc.learnbot.commands.Lift;
...
public class TestController implements Loggable {
    ...
    public void bindControls() {
        liftLow.whenPressed(Lift.LowCommand(robot.placementSubsystem));
        liftMid.whenPressed(Lift.MediumCommand(robot.placementSubsystem));
        liftHigh.whenPressed(Lift.HighCommand(robot.placementSubsystem));
    }
}
